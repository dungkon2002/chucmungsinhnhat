...
function Fly(fid, type, color, sh, sw, x, y, fly_img, name, title) {
	...
	if(this.name == 'Nhạc Bất Ruồi'){
		...
		$(t).html(this.name + " nói:\n"+'"Chúc sóc tuổi mới ngoan ngoan hơn, mạnh khỏe hơn,"');
		this.gender = "Cái";
